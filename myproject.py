...
class obp:
    ...
    def title(self):
        ...
        Label(root, image=img).grid(row=0, column=0, padx=600, pady=15)
        Label(
            root,
        ...
        Label(root, text="", fg="blue", font="Ariel 15").grid(
            row=3, column=0
        )
        Label(
            root, text="Mobile: 8349062155\n", fg="blue", font="Ariel 15", pady=20
        ).grid(row=4, column=0)
        Label(
            root,
            text="Project",
        ...
        Label(root, text="Project Based Learning", fg="red", font="Ariel 12 bold").grid(
            row=8, column=0
        )
        ...
        Button(
            root, text="  Next → ", font="Ariel 10 bold", bg="OliveDrab1", command=n
        ).grid(row=9, column=0, columnspan=20, pady=10)
        root.mainloop()
    ...
    def page1(self):
        ...
        Label(fr, image=img).grid(row=0, column=0,
                                  padx=600, pady=20, columnspan=100)
        Label(
            fr1,
            text="Online Bus Booking System",
            font="Ariel 25 bold",
        ...
        Label(fr2, text="For Admin Only", font="Ariel 10 bold", fg="red").grid(
    ...
    def new_details(self):
        ...
        Button(
            fr2, text="New Bus", bg="orange", font="Areil 10 bold", command=new_bus
        ).grid(row=3, column=1, padx=10)
        Button(
            fr2, text="New Route", bg="blue", font="Areil 10 bold", command=new_route
        ).grid(row=3, column=2, padx=10)
        Button(
            fr2, text="New Run", bg="brown", font="Areil 10 bold", command=new_run
    ...
    def check_booked_seats(self):
        ...
        root.geometry("1500x1000")
        img = PhotoImage(file="starbus.png")
        Label(root, image=img).grid(row=0, column=0, padx=600)
        Label(
            root,
            text="Online Bus Booking System",
            font="Ariel 25 bold",
        ...
        Label(fr, text="Enter Your Mobile No : ", font="Ariel 12 bold").grid(
            row=0, column=0, padx=10
        )

        def validate_mobail_number(new_value):
            return new_value.isdigit() and len(new_value) <= 10
        phone_no = Entry(fr, font="Ariel 12 bold", validate="key", validatecommand=(
            fr.register(validate_mobail_number), '%P'))
        ...
        def check():
            try:
                ...
                cur.execute(
                    "select * from booking_history where phone = ?  ", (int(
                        Number),)
                )
                passenger_info = cur.fetchall()
                if passenger_info == []:
                    answer = askyesno(
                        title="No Booking Record",
                ...
                cur.execute(
                    "select * from bus_details where busid = ?", (
                        passenger_info[8],)
                )
                ...
                cur.execute(
                    "select * from route_details where route_id = ?",
                ...
                total_fare = int(
                    passenger_info[3]) * int(passenger_Bus_info[3])
                Label(
                    fr1, text="Passenger : " + passenger_info[1], font="Ariel 12 bold"
                ).grid(row=0, column=0)
                Label(
                    fr1, text="Gender : " + passenger_info[2], font="Ariel 12 bold"
                ).grid(row=0, column=1)
                Label(
                    fr1,
                    text="No of seats : " + str(passenger_info[3]),
                    font="Ariel 12 bold",
                ).grid(row=1, column=0)
                Label(
                    fr1, text="Phone : " + str(passenger_info[4]), font="Ariel 12 bold"
                ).grid(row=1, column=1)
                Label(
                    fr1, text="Age : " + str(passenger_info[5]), font="Ariel 12 bold"
                ).grid(row=2, column=0)
                Label(
                    fr1, text="Fare Rs : " + str(total_fare), font="Ariel 12 bold"
                ).grid(row=2, column=1)
                Label(
                    fr1,
                    text="Booking ref : " + str(passenger_info[0]),
                    font="Ariel 12 bold",
                ).grid(row=3, column=0)
                Label(
                    fr1,
                    text="Bus Details : " + passenger_operator_info[1],
                    font="Ariel 12 bold",
                ).grid(row=3, column=1)
                Label(
                    fr1,
                    text="Travel on : " + str(passenger_info[7]),
                    font="Ariel 12 bold",
                ).grid(row=4, column=0)
                Label(
                    fr1,
                    text="Booked on : " + str(passenger_info[6]),
                    font="Ariel 12 bold",
                ).grid(row=4, column=1)
                Label(
                    fr1,
                    text="Operator contact : " +
                    str(passenger_operator_info[3]),
                    font="Ariel 12 bold",
                ).grid(row=5, column=0)
                Label(
                    fr1,
                    text="Boarding Point : " + passenger_info[9],
                    font="Ariel 12 bold",
                ).grid(row=5, column=1)
                Label(
                    fr1,
                    ...
                    + str(total_fare)
                    + " to be paid at the time of boarding the bus.",
                    fg="red",
                    font="Ariel 10 bold").grid(row=6, column=0, columnspan=4)

                def hom():
                    root.destroy()
                    self.page1()
                # im = PhotoImage(file = "home.png")
                Button(fr1, text=" HOME ", bg="yellow",
                       command=hom).grid(row=7, column=0, columnspan=4, pady=15)
            except ValueError:
                messagebox.showerror("Incorrect Number",
        ...
        Button(fr, text="Check Booking", command=check, font="Ariel 13 bold").grid(
    ...
    def book_your_seats(self):
        ...
        cur = con.cursor()
        cur.execute(
            "create table if not exists booking_history(booking_ref INTEGER PRIMARY KEY AUTOINCREMENT,name varchar(20),gender varchar(10),no_of_seat int,phone big int,age int,booking_date date,travel_date date,bus_id int,Boarding_point varchar(10),CONSTRAINT fk1 foreign key(bus_id) references bus(busid) ON DELETE CASCADE)"
        )
        root = Tk()
        root.title("online bus booking system")
        root.geometry("1500x1000")
        ...
        Label(fr, image=img).grid(row=0, column=0, padx=600, columnspan=100)
        Label(
            fr1,
            text="Online Bus Booking System",
            font="Ariel 25 bold",
        ...
        Label(fr2, text="Journey Date",
              font="Ariel 10 bold").grid(row=3, column=4)
        ...
        def set_passenger_details():
            try:
                ...
                if Seat_avl < 0:
                    raise Exception(
                        messagebox.showerror(
                            "No Seats Available",
                            "Sorry Only " +
                            str(details2[2]) + " Seats Are Available",
                        )
                    )
                ...
                if int(Age) < 6 or int(Age) > 120:
                    raise Exception(
                        messagebox.showerror(
                            "Age Limit", "Please Check age limits"
                        )
                    )
                ...
                if answer == True:
                    cur.execute(
                        "insert into booking_history (name,gender,no_of_seat,phone,age,booking_date,travel_date,bus_id,Boarding_point) values(?,?,?,?,?,?,?,?,?)",
                        info,
                    )
                    cur.execute("select * from booking_history")
                    print(cur.fetchall())
                    cur.execute(
                        "update run_details set seat_avl = ? where bus_id = ? ",
                        (Seat_avl, details2[6]),
                    )
                    con.commit()
                    root.destroy()
        ...
        def get_passenger_details():
            ...
            if variable == -1:
                raise Exception(
                    messagebox.showerror("Select Bus", "Please select bus !")
                )
            Label(
                fr4,
                text="Fill passenger details to book the bus",
                fg="green",
                bg="light blue",
                relief="ridge",
                font="Areil 15 bold",
            ...
            def validate_mobail_number(new_value):
                return new_value.isdigit() and len(new_value) <= 10
            mobail = Entry(fr5, validate="key", validatecommand=(
                fr5.register(validate_mobail_number), '%P'))
        ...
        def show_bus():
            ...
            cur.execute(
                "select * from route_details where station_Name = ? order by route_id",
                (From,),
            )
            ...
            for i in From_details:
                cur.execute(
                    "select * from route_details where station_Name = ? and Route_id = ? order by route_id",
                    (To, i[0]),
                )
            ...
            for i in rid:
                cur.execute(
                    "select * from bus_details where route_id = ?", (i,))
            ...
            Label(fr3, text="Select Bus", fg="red", font="Areil 12 bold").grid(
                row=0, column=0, padx=30
            )
            Label(fr3, text="Operator", fg="red", font="Areil 10 bold").grid(
                row=0, column=1, padx=30
            )
            Label(fr3, text="Bus Type", fg="red", font="Areil 10 bold").grid(
                row=0, column=2, padx=30
            )
            Label(fr3, text="Available/Capacity", fg="red", font="Areil 10 bold").grid(
                row=0, column=3, padx=30
            )
                ...
                for j in Bus_details:
                    for k in j:
                        if Run_detail[0] == k[0]:
                            ...
                            Bus_Button[temp1] = Button(
                                fr3,
                                text="Bus" + str(temp1 + 1),
                                command=call_make_something,
                                bg="springgreen2",
                                activebackground="blue",
                                font="Ariel 10 bold",
                            )
                            Bus_Button[temp1].grid(
                                row=temp1 + 1, column=0, padx=30, pady=8
                            )
                            Label(
                                fr3,
                                text=operator_detail,
                                fg="blue",
                                font="Areil 10 bold",
                            ).grid(row=temp1 + 1, column=1, padx=30)
                            # operator details
                            temp2 = temp2 + (operator_detail,)
                            Label(fr3, text=k[1], fg="blue", font="Areil 10 bold").grid(
                                row=temp1 + 1, column=2, padx=30
                            )
                            temp2 = temp2 + (k[1],)  # Bus type
                            Label(
                                fr3,
                                text=str(Run_detail[2]) + "/" + str(k[2]),
                                fg="blue",
                                font="Areil 10 bold",
                            ).grid(row=temp1 + 1, column=3, padx=30)
                            ...
                            Button(
                                ...
                                bg="springgreen2",
                                font="Ariel 10 bold",
                                command=get_passenger_details,
                            ).grid(row=temp1 + 1, column=5, padx=30)
                            temp2 = temp2 + (date,)
                            temp2 = temp2 + (k[0],)
                            temp2 = temp2 + (From,)
                            temp1 = temp1 + 1
        ...
        Button(fr2, image=im, bg="springgreen2",
               command=hom).grid(row=3, column=7)
        root.mainloop()
    ...
    def bus_ticket(self):
        ...
        cur.execute(
            "select * from booking_history order by booking_ref desc limit 1 ")
        passenger_info = cur.fetchall()
        passenger_info = passenger_info[0]
        ...
        Label(fr1, text="Passenger : " + passenger_info[1], font="Ariel 10 bold").grid(
            row=0, column=0
        )
        Label(fr1, text="Gender : " + passenger_info[2], font="Ariel 10 bold").grid(
            row=0, column=1
        )
        Label(
            fr1, text="No of seats : " + str(passenger_info[3]), font="Ariel 10 bold"
        ).grid(row=1, column=0)
        Label(fr1, text="Phone : " + str(passenger_info[4]), font="Ariel 10 bold").grid(
            row=1, column=1
        )
        Label(fr1, text="Age : " + str(passenger_info[5]), font="Ariel 10 bold").grid(
            row=2, column=0
        )
        Label(fr1, text="Fare Rs : " + str(total_fare), font="Ariel 10 bold").grid(
            row=2, column=1
        )
        Label(
            fr1, text="Booking ref : " + str(passenger_info[0]), font="Ariel 10 bold"
        ).grid(row=3, column=0)
        Label(
            fr1,
            text="Bus Details : " + passenger_operator_info[1],
        ...
        Label(
            fr1, text="Travel on : " + str(passenger_info[7]), font="Ariel 10 bold"
        ).grid(row=4, column=0)
        Label(
            fr1, text="Booked on : " + str(passenger_info[6]), font="Ariel 10 bold"
        ).grid(row=4, column=1)
        Label(
            fr1,
            text="Operator contact : " + str(passenger_operator_info[3]),
            font="Ariel 10 bold",
        ).grid(row=5, column=0)
        Label(
            fr1,
        ...
        def hom():
            ...
            self.page1()
        # im = PhotoImage(file = "home.png")
        Button(root, text=" HOME ", bg="yellow",
               command=hom).grid(row=4, column=0, pady=15)
        root.mainloop()
    ...
    def New_Operator(self):
        ...
        def validate_mobail_number(new_value):
            return new_value.isdigit() and len(new_value) <= 10
        Phone = Entry(fr2, font="Ariel 12 bold", validate="key", validatecommand=(
            fr2.register(validate_mobail_number), '%P'))
        ...
        Button(fr2, image=im, bg="springgreen2", command=go_home).grid(
            row=3, column=12, padx=5
        )
        Label(
            fr2,
        )
        ...
        def ad():
            ...
            try:
                cur.execute(
                    ...
                    (int(oid), n, adr, int(p), e),
                )
                messagebox.showinfo(
                    "operator entry", "operator added successfully")
        ...
        Button(
            fr2, text="Add", bg="springgreen2", font="Areil 10 bold", command=ad
        ).grid(row=3, column=10, padx=5)
        ...
        def edit():
            ...
            cur.execute(
                "select * from operators where operator_id=?", (int(oid),))
            olist = cur.fetchall()
            if olist == []:
                raise Exception(
                    messagebox.showerror(
                        "operator updation", "no such record exist")
                )
            cur.execute(
            ...
            messagebox.showinfo(
                "operator enrty update", "operator record updated successfully"
            )
            con.commit()
            Label(
                fr2, text="   " + oid + " " + n + " " + adr + " " + p + " " + e + "   "
            ).grid(row=5, column=0, columnspan=15)
            Opid.delete(0, END)
            Name.delete(0, END)
            Address.delete(0, END)
            Phone.delete(0, END)
        ...
        Button(
            fr2, text="Edit", bg="springgreen2", font="Areil 10 bold", command=edit
    ...
    def New_Bus(self):
            ...
            try:
                if Btype == "Bus Type":
                    raise Exception(
                        messagebox.showerror(
                            "BusTypeError",
                            "Bus Type can't be 'Bus Type' select an option",
                        )
                    )
                ...
                messagebox.showerror(
                    "insertion error", "record already exists")
            except ValueError:
                messagebox.showerror(
        ...
        def edit_bus():
            ...
            try:
                ...
                cur.execute(
                    "select * from bus_details where busid=?", (int(Bid),))
                blist = cur.fetchall()
                if blist == []:
                ...
                messagebox.showinfo(
                    "bus enrty update", "bus record upadted successfully"
                )
            except ValueError:
                messagebox.showerror(
                    "Value Error", "wrong entry please check input and try again"
        ...
        Button(fr3, image=im, bg="green", command=go_home).grid(
            row=5, column=4, padx=10
        )
    ...
    def New_Route(self):
        ...
        def add():
            ...
            try:
                ...
                cur.execute(
                    "select station_id from route_details where station_name=? group by station_id",
                    (Stname,),
                )
                slist = cur.fetchall()
                cur.execute(
                    "select station_name from route_details where station_id=? group by station_name",
                    (int(Stid),),
                )
                snlist = cur.fetchall()
                if slist == [] and snlist == []:
                    cur.execute(
                        ...
                        (int(Rid), Stname, int(Stid), 0),
                    )
                    cur.execute(
                        "insert into route_details values(?,?,?,?)",
                        (int(Rid) + 1, Stname, int(Stid), 1),
                    )
                    ...
                    if slist[0] == int(Stid) and snlist[0] == Stname:
                        ...
                        raise EXCEPTION(
                            messagebox.showerror(
                                "wrong enrty",
                                "station id and station name cannot be matched",
                            )
                        )
                else:
                    raise EXCEPTION(
                ...
                Label(fr2, text=Rid + " " + Stname +
                      " " + Stid).grid(row=4, column=2)
        ...
        def de():
            ...
            try:
                if Rid == "":
                    raise Exception(
                        messagebox.showerror(
                            "blank_field", "route_id field cannot be blank"
                        )
                    )
                cur.execute(
                    "select * from route_details where route_id=?", (int(Rid),))
                rlist = cur.fetchall()
                if rlist == []:
                    raise EXCEPTION(
                        messagebox.showerror(
                            "deletion error", "no such record exist")
                    )
                cur.execute(
                ...
                messagebox.showinfo(
                    "route deletion", "route deleted successfully")
                con.commit()
            except ValueError:
                messagebox.showerror(
                    "Value Error", "wrong entry please check input and try again"
        ...
        Button(fr2, image=im, bg="springgreen2",
               command=hom).grid(row=3, column=8)
    ...
    def New_Run(self):
        ...
        rdate = DateEntry(fr2, date_pattern="yyyy-mm-dd")
        ...
        def delrun():
            ...
            try:
                ...
                messagebox.showinfo("record deletion",
        ...
        Button(
            fr2, text="Delete Run", bg="springgreen2", fg="red2", command=delrun
        ).grid(row=3, column=7, padx=10)
        ...
        im = PhotoImage(file="home.png")
        Button(fr2, image=im, bg="springgreen2", command=hom).grid(
            row=3, column=8, padx=10
        )
